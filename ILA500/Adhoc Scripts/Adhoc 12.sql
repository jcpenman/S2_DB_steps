-- Name:Adhoc 12
-- Description: This script has been created to update the IUD Audit Triggers for ILA500, the last_updated_by column was not picking
--              up the username of the user carrying out the update, trigger code has been amended to fix this issue
--
-- MODIFICATION HISTORY:
-- Ref      Date          Author                  Desc.
-- 001      25.11.2009    A.Bowman (SAAS)         Initial Version.
-- 002      21.06.2010    A.Bowman (SAAS)         Triggers have been amended so this script has been updated accordingly.
--
...
CREATE OR REPLACE TRIGGER debt_status_iud
