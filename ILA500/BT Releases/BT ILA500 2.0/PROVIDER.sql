...
-- Ref      Date        Autho                   Desc.
--          27.05.08   A.Bowman (SAAS)         Initial Version.
--
-- 
-- Configuration Management:
-- $HeadURL: svn://192.168.186.3/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/ILA500/BT%20Releases/BT%20ILA500%202.0/PROVIDER.sql $
-- $Author: $
...
(
  ...
  MAIN_CONTACT_TEL_NO            NUMBER(15),
  MAIN_CONTACT_FAX_NO            NUMBER(15),
  MAIN_CONTACT_EMAIL             VARCHAR2(80 BYTE),
  FIN_CONTACT_NAME               VARCHAR2(50 BYTE) NOT NULL,
  FIN_CONTACT_POSITION           VARCHAR2(30 BYTE) NOT NULL,
  ...
  FIN_CONTACT_TEL_NO             NUMBER(15),
  FIN_CONTACT_FAX_NO             NUMBER(15),
