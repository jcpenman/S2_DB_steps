-- VU_SDS.sql
-- Description: dbView holding all learner contact detail and application status change data for ILA500 SDS interface for 2010 session year.
-- Author R. Hunter.(SAAS) 
--
-- MODIFICATION HISTORY:
-- Ref      Date        Author                  Desc.
-- 1.0      05.08.10    P Hughes (SAAS)         Initial Version.

--
-- Configuration Management:
-- $HeadURL: svn://192.168.186.3:3690/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/ILA500/Views/VU_SDS.sql $
-- $Author: $
-- $Date: 2010-07-30 14:23:14 +0100 (Fri, 30 Jul 2010) $
-- $Revision: 5515 $

DROP VIEW ILA500.VU_SDS2010;

CREATE OR REPLACE FORCE VIEW ila500.vu_sds2010 (ila_ref_no,
                                                title,
                                                title_change_date,
                                                last_name,
                                                surname_change_date,
...
GRANT DELETE, INSERT, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE ON  VU_SDS2010 TO EDM_USER;
