...
--1.11      28.03.11    P.Hughes (SAAS)         Added proper bank and suspense account details supplied by finance.
--1.12      10.01.12    P.Hughes (SAAS)         Update ISB Account
--
...
INSERT INTO stud_award_type
     ...
     VALUES ('PAYMENTS', 'PAY', null, 'BACS RETURN', 
...
INSERT INTO stud_award_type
     ...
     VALUES ('PAYMENTS', 'PAY', null, 'CANCELLED PO', 
             'N', '213260', 'ECC', '12205985',
             '600', 'N', 'PAYMENT ACCOUNT INFORMATION', 'PAY' 
            );  
INSERT INTO stud_award_type
            (stud_award_type, loan_non_loan_fee, scheme, award_type_descript,
     ...
     VALUES ('PAYMENTS', 'PAY', null, 'DISHONOURED CHEQUE', 
             'N', '213260', 'ECC', '12205980',
             '600', 'N', 'PAYMENT ACCOUNT INFORMATION', 'PAY' 
            );  
INSERT INTO stud_award_type
            (stud_award_type, loan_non_loan_fee, scheme, award_type_descript,
     ...
     VALUES ('PAYMENTS', 'PAY', null, 'RECEIPT', 
             'N', '213260', 'ECC', '12205980',
             '600', 'N', 'PAYMENT ACCOUNT INFORMATION', 'PAY' 
            );  
INSERT INTO stud_award_type
     ...
     VALUES ('PAYMENTS', 'PAY', null, 'RETURNED PAYMENT', 
             'N', '213260', 'ECC', '12205980',
             '600', 'N', 'PAYMENT ACCOUNT INFORMATION', 'PAY' 
            ); 
INSERT INTO stud_award_type
     ...
     VALUES ('PAYMENTS', 'PAY', null, 'TIME EXPIRED PO', 
             'N', '213260', 'ECC', '20003305',
             '600', 'N', 'PAYMENT ACCOUNT INFORMATION', 'PAY' 
            ); 
