...
-- $HeadURL: svn://192.168.186.3/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/STUD_CONT_DETAILS.sql $
-- $Author: $
-- $Date: 2011-10-10 14:21:29 +0100 (Mon, 10 Oct 2011) $
-- $Revision: 7446 $
--
...
CREATE UNIQUE INDEX SGAS.STUD_CONT_DETAILS_PK ON SGAS.STUD_CONT_DETAILS
(STUD_REF_NO,CONTACT_IND)
LOGGING
TABLESPACE USERS
PCTFREE    10
