...
-- 11.03.2011    A.Bowman     022   Added new functionality to ST_IUD trigger to update changed since last report flag on the attendance_data table
-- 16.11.2012    A.Bowman     023   Added new columns comp_jour and nrs_cb
-- 
--
-- Configuration Management:
-- $HeadURL: svn://192.168.186.3/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/STUD.sql $
-- $Author: $
...
(
  ...
  COMP_JOUR                   VARCHAR2(1) DEFAULT 'N',
  NRS_CB                      VARCHAR2(1),  
  -- 004 - Audit Columns
