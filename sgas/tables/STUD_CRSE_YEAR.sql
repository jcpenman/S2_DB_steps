...
-- 11.03.11   A.Bowman      015    Added new functionality to STCY_IUD trigger to update changed since last report flag on attendance_data table, chng_since_last_report removed from this table
...
-- $HeadURL: svn://192.168.186.3/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/STUD_CRSE_YEAR.sql $
-- $Author: $
-- $Date: 2011-10-20 14:53:11 +0100 (Thu, 20 Oct 2011) $
-- $Revision: 7469 $
...
(
  ...
  PAY_YSB                       VARCHAR2(1 BYTE) DEFAULT 'N',
  ...
  PAY_ISB                       VARCHAR2(1 BYTE) DEFAULT 'N',            
