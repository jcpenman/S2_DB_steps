 ...
 * $HeadURL: svn://192.168.186.3/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/CONFIG_DATA.sql $ 
 * $Author: $ 
 * $Date: 2011-11-17 15:48:12 +0000 (Thu, 17 Nov 2011) $ 
 * $Revision: 7521 $ 
 */
...
INSERT INTO config_data
     ...
     VALUES ('CURRENT_SESSION', '2011', NULL
            );
INSERT INTO config_data
            (item_name, cval, nval
            )
...
INSERT INTO config_data
     ...
     VALUES ('STEPS_RELEASE_YEAR', NULL, 2011
            );
INSERT INTO config_data
            (item_name, cval, nval
            )
...
INSERT INTO config_data
     ...
     VALUES ('MAX_BATCH_PAYMENTS', NULL, 10000
            );   
INSERT INTO CONFIG_DATA
            (item_name, cval, nval
            )
...
INSERT INTO CONFIG_DATA 
     ...
     VALUES('SEAS_FINANCE_CONT_NAME','SAAS FINANCE', NULL
             ); 
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('SEAS_FINANCE_CONT_EXT','Ext 45824', NULL
             ); 
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
...
INSERT INTO CONFIG_DATA 
     ...
     VALUES('STUDENT_STATUS_REPORT_ARCHIVE','/projects/app/webmethods/reports/ReportsToInstitutions/StudentStatusReports/StatusReportArchive', NULL
             ); 
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('FEE_PAYMENT_REPORT_ARCHIVE','/projects/app/webmethods/reports/ReportsToInstitutions/FeePaymentReports/FeeReportArchive', NULL
             ); 
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('WEB_PASSWORD_LETTER','/projects/app/webmethods/letters/password_letters', NULL
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('NO_ENROL_PAYMENTS_SCOT',NULL, 1
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('NO_ENROL_PAYMENTS_RUK',NULL, 1
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('NO_ATTEND_PAYMENTS_SCOT',NULL, 5
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('NO_ATTEND_PAYMENTS_RUK',NULL, 1
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('NO_DAYS_ONGOING_ATTEND',NULL, 60
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('NO_DAYS_LATE_APP',NULL, 21
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES('FEE_PAYMENT_ATTEND','E', NULL
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
    VALUES ('TELE_DEST', '/projects/steps/telephony/', NULL
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
    VALUES ('STEPS_INVALID_CHARS', ';|,', NULL
             );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES ('AWARD_LETTER_DAYS', NULL, 3
            );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES ('MAX_AWARD_LETTER_REQ', NULL, 5
            );
INSERT INTO CONFIG_DATA 
            (ITEM_NAME, CVAL, NVAL 
            ) 
     VALUES ('LOA_LOCATION', '/projects/sgas/temp/telephony/', NULL
            ); 
COMMIT; 
