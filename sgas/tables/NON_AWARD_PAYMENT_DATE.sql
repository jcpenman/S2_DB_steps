...
-- 1.1      28.03.11    P.Hughes (SAAS)         Added Non payment dates
...
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('22-04-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('25-04-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('29-04-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('02-05-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('30-05-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('29-08-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('26-12-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('27-12-2011','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('02-01-2012','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('03-01-2012','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('06-04-2012','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('09-04-2012','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('07-05-2012','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('04-06-2012','DD-MM-YYYY')
            );
INSERT INTO non_award_payment_date
            (non_pay_date
            )
     VALUES (TO_DATE('05-06-2012','DD-MM-YYYY')
            );
