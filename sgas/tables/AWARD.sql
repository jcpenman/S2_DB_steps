...
-- 011 11.03.11    A.Bowman (SAAS) Added new functionality to AW_IUD trigger to update change since last report flag on the attendance_data table
...
-- $HeadURL: svn://192.168.186.3/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/AWARD.sql $
-- $Author: $
-- $Date: 2011-03-11 13:43:10 +0000 (Fri, 11 Mar 2011) $
-- $Revision: 6628 $
