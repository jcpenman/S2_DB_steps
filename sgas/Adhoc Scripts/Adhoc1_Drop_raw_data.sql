...
alter table EDM.raw_data$test_data add STUD_INCOME_AMT1 Varchar2(11);

alter table EDM.raw_data$test_data add STUD_INCOME_TYPE1 Varchar2(1);

alter table EDM.raw_data$test_data add STUD_INCOME_AMT2 Varchar2(11);

alter table EDM.raw_data$test_data add STUD_INCOME_TYPE2 Varchar2(1);

alter table EDM.raw_data$test_data add STUD_INCOME_AMT3 Varchar2(11);

alter table EDM.raw_data$test_data add STUD_INCOME_TYPE3 Varchar2(1);

alter table EDM.raw_data$test_data add STUD_INCOME_AMT4 Varchar2(11);

alter table EDM.raw_data$test_data add STUD_INCOME_TYPE4 Varchar2(1);

alter table EDM.raw_data$test_data add STUD_INCOME_AMT5 Varchar2(11);

alter table EDM.raw_data$test_data add STUD_INCOME_TYPE5 Varchar2(1);

alter table EDM.raw_data$test_data add STUD_INCOME_AMT6 Varchar2(11);

alter table EDM.raw_data$test_data add STUD_INCOME_TYPE6 Varchar2(1);

alter table EDM.raw_data$test_data add REASON_NO_INCOME_BEN1 Varchar2(60);

alter table EDM.raw_data$test_data add REASON_NO_INCOME_BEN2 Varchar2(60);
