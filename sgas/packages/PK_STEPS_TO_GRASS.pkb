/* Formatted on 2011/06/08 11:22 (Formatter Plus v4.8.8) */
...
--
   ...
   BEGIN
      ...
      INSERT INTO stud_home_addr@grass
                  (stud_ref_no, start_date, out_uk, house_no_name,
                   addr_l1, addr_l2, addr_l3, addr_l4, post_code,
                   addr_easting, addr_northing, tele_no, end_date,
                   mailsort
                  )
           VALUES (p_stud_ref_no, SYSDATE, p_out_uk, p_house_no_name,
                   p_addr_l1, p_addr_l2, p_addr_l3, p_addr_l4, p_post_code,
                   p_addr_easting, p_addr_northing, p_tele_no, p_end_date,
                   p_mailsort
                  );
   ...
   BEGIN
      ...
      INSERT INTO stud_term_addr@grass
                  (stud_ref_no, start_date, location_ind, residence_ind,
                   house_no_name, addr_l1, addr_l2, addr_l3,
                   addr_l4, post_code, addr_easting, addr_northing,
                   tele_no, end_date, mailsort
                  )
           VALUES (p_stud_ref_no, SYSDATE, p_location_ind, p_residence_ind,
                   p_house_no_name, p_addr_l1, p_addr_l2, p_addr_l3,
                   p_addr_l4, p_post_code, p_addr_easting, p_addr_northing,
   ...
   BEGIN
      ...
      SELECT stg.payment_method, stg.ni_no, stg.account_no, stg.sort_code
        INTO v_payment_method, v_ni_no, v_account_no, v_sort_code
        FROM stud@grass stg
       WHERE stg.stud_ref_no = p_stud_ref_no;

      IF v_payment_method <> p_payment_method
      THEN
         upd_batch_recalc := 'Y';
      ELSIF v_ni_no <> p_ni_no
      THEN
         upd_batch_recalc := 'Y';
      ELSIF v_account_no <> p_account_no
      THEN
         upd_batch_recalc := 'Y';
      ELSIF v_sort_code <> p_sort_code
      THEN
         upd_batch_recalc := 'Y';
      END IF;

      IF upd_batch_recalc = 'Y'
      THEN
