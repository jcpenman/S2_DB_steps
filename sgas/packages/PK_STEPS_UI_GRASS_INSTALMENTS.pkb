...
PROCEDURE instalments (
   ...
   BEGIN
      OPEN inst_cursor FOR
        SELECT   a.award_type_descript AS award_type,
				 ai.payment_due_date AS due_date,
				 ai.amount AS amt, 
				 ai.contrib_amount AS contrib_amt,
                 ai.recovered_amount AS recovered_amt, 
				 ai.unclaimed_loan AS unclaimed_loan, 
				 ai.net_amount AS net_amt, 
				 a.overpayment_amount AS overpayment_amt, 
