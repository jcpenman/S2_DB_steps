...
AS
   ...
   ******************************************************************************/
   ...
   PROCEDURE getdd_dsa_app_statuses (io_cursor       IN OUT dd_cursor_dsa_app_statuses,
									 ...
									 ERROR_TEXT         OUT VARCHAR2)
   AS
      dd_cursor   dd_cursor_dsa_app_statuses;
   BEGIN
      OPEN dd_cursor FOR
           SELECT das.dsa_app_status_id AS KEY, das.dsa_app_status AS label
             FROM dsa_app_status das
         ORDER BY das.dsa_app_status_id;
