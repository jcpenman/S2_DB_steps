CREATE OR REPLACE PACKAGE SGAS.SHORTENED_APPLICATION_WEB_ST_SINGLE_SRN
  IS
--
...
--
FUNCTION shwap_loop  (p_stud_ref_no IN completed_shwap.stud_ref_no%TYPE) RETURN VARCHAR2 ;
--
