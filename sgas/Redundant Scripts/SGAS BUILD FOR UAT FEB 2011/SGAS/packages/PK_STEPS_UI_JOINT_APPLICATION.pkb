/* Formatted on 2010/12/06 11:27 (Formatter Plus v4.8.8) */
      ...
      OPEN jm_cursor FOR
         SELECT ss.stud_session_id
          ...
          WHERE ss.ja_case = 'Y'
            ...
            AND (   (ss.ben1_id IN (v_ben1_id, v_ben2_id))
                 OR (    ss.ben1_id IN (v_ben1_id, v_ben2_id)
                     AND ss.ben2_id IN (v_ben1_id, v_ben2_id)
                    )
                );
