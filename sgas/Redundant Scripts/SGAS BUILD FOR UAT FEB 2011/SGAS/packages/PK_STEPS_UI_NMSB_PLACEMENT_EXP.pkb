/* Formatted on 2010/11/24 10:53 (Formatter Plus v4.8.8) */
 ...
 */
   ...
   AS
      temp_stud_crse_year_id   NUMBER (9);
   ...
   BEGIN
       ...
       */
      SELECT scy.stud_crse_year_id, scy.inst_code, scy.crse_id,
             scy.crse_year_no
        INTO temp_stud_crse_year_id, temp_inst_code, temp_crse_id,
             temp_crse_year_no
      ...
      INSERT INTO award
           ...
           VALUES (aw_award_id_seq.NEXTVAL, temp_stud_crse_year_id, 'A',
                   NULL, 'SNPE',
