/* Formatted on 2010/08/02 15:04 (Formatter Plus v4.8.8) */
...
AS
   ...
   BEGIN
      INSERT INTO nominee
           ...
           VALUES (UPPER (forename_in), UPPER (surname_in),
                   UPPER (company_name_in), UPPER (payee_name_in),
