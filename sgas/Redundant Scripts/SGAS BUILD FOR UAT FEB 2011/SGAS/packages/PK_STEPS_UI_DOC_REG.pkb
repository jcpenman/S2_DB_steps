   ...
   BEGIN
      OPEN dr_cursor FOR
         SELECT ar.applic_reg_id, ar.session_code, ar.doc_type_id,
                ar.document_type, to_char(to_date(ar.received_date, 'DD-MM-YYYY')) as received_date, to_char(to_date(ar.returned_date, 'DD-MM-YYYY')) as returned_date,
                ar.last_updated_by, to_char(to_date(ar.last_updated_on, 'DD-MM-YYYY')) as last_updated_on
           FROM applic_reg ar
