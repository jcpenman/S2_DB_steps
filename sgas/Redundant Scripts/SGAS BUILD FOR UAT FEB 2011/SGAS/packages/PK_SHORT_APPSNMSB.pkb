CREATE OR REPLACE PACKAGE BODY SGAS.pk_short_appsNMSB
AS

/******************************************************************************
   NAME:       pk_short_appsNMSB
   PURPOSE:     To provide data to populate Student Applications for Shortenned Applications
                This points to the STEPS Database
...
******************************************************************************/
   ...
   PROCEDURE shortappNMSB (
      p_stud_ref_no    IN       NUMBER,
      p_session_code   IN       NUMBER,
      io_cursor        IN OUT   shortappNMSB_cursor
   )
   IS
      adh_cursor   shortappNMSB_cursor;
   BEGIN
      OPEN adh_cursor FOR
