-- PASSWORD_LETTER_REQUEST.sql
-- Description: Table holding web password letter requests
-- Author R. Hunter.(SAAS) 
--
-- MODIFICATION HISTORY:
-- Ref      Date        Author                  Desc.
-- 1.0      25.05.09    R Hunter (SAAS)         Initial Version.
--
...
-- $Date:  $
-- $Revision: $
DROP TABLE SGAS.PASSWORD_LETTER_REQUEST CASCADE CONSTRAINTS
/

--
-- PASSWORD_LETTER_REQUEST  (Table) 
--
CREATE TABLE SGAS.PASSWORD_LETTER_REQUEST
(
