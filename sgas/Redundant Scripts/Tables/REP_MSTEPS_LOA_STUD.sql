...
-------------------------
$HeadURL: svn://192.168.186.3:3690/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/REP_MSTEPS_LOA_STUD.sql $ 
$Author: $ 
...
ALTER TABLE SGAS.REP_MSTEPS_LOA_STUD
 DROP PRIMARY KEY CASCADE
/
DROP TABLE SGAS.REP_MSTEPS_LOA_STUD CASCADE CONSTRAINTS
/

--
-- REP_MSTEPS_LOA_STUD  (Table) 
--
CREATE TABLE SGAS.REP_MSTEPS_LOA_STUD
(
...
COMMENT ON COLUMN SGAS.REP_MSTEPS_LOA_STUD.REM14 IS 'Flag to indicate if remark 14 is to be printed on the view previous LOA'
/
...
-- P_STUD_PK  (Index) 
--
CREATE UNIQUE INDEX P_RMLS_STUD_PK ON SGAS.REP_MSTEPS_LOA_STUD
(STUD_CRSE_YEAR_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
-- 
-- Non Foreign Key Constraints for Table REP_MSTEPS_LOA_STUD 
-- 
ALTER TABLE SGAS.REP_MSTEPS_LOA_STUD ADD (
  CONSTRAINT P_RMLS_STUD_PK
 PRIMARY KEY
 (STUD_CRSE_YEAR_ID)
    USING INDEX 
    TABLESPACE USERS
