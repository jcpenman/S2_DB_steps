...
-------------------------
$HeadURL: svn://192.168.186.3:3690/projects/sgas/tradev/svnRepositories/steps/trunk/Database/steps/sgas/tables/REP_MSTEPS_LOA_PAYMENTS.sql $ 
$Author: $ 
$Date: 2009-07-02 10:17:09 +0100 (Thu, 02 Jul 2009) $ 
$Revision: 3341 $ 
 
*******************************************************************************/
DROP TABLE SGAS.REP_MSTEPS_LOA_PAYMENTS CASCADE CONSTRAINTS
/

--
-- REP_MSTEPS_LOA_PAYMENTS  (Table) 
--
CREATE TABLE SGAS.REP_MSTEPS_LOA_PAYMENTS
(
...
-- SCY_ID_PAY  (Index) 
--
CREATE INDEX S1_RMLP_SCY_ID ON SGAS.REP_MSTEPS_LOA_PAYMENTS
(STUD_CRSE_YEAR_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
