/* Formatted on 2012/01/25 15:01 (Formatter Plus v4.8.8) */
...
--
           AND                     -- For new or corrected flts send a file 1.
               (   (    NVL (fl.status, 'Z') IN ('Z', 'C')
                    -- flt recs not sent or sent and corrected.
                    AND NVL (ss.slc1_fl_sent, 'N') = 'N'
